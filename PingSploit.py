...
def pingsploit(dest_name, max_hops=30, timeout=2, interval=1, flood=False, fast=False, spoof=False, source_ip=None, resolve=False):
...
if __name__ == "__main__":
    args = parse_args()
    pingsploit(args.destination, args.count, args.timeout, args.size, args.flood, args.ping_forever, args.spoof, args.source_address, args.resolve)
